    ...
    <section ref={ref} className="relative min-h-[100svh] flex flex-col justify-end pt-20 pb-8 sm:pb-12 px-4 sm:px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-6 sm:gap-10 mt-auto">
        ...
        <motion.div
          ...
          style={{ opacity }}
          className="max-w-[85vw] sm:max-w-xs md:max-w-sm"
        >
        ...
        <motion.div
          ...
          className="h-[2px] bg-emerald origin-left max-w-md"
        />
      </div>
      ...
      <motion.div
        ...
        className="absolute bottom-8 sm:bottom-12 right-4 sm:right-6 md:right-12 text-right text-xs text-muted-foreground tracking-wide z-10"
      >
